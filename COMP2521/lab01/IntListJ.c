...
//A Helper function that creates a new node of a list
...
//A helper function to print the linked list
...
void IntListInsertInOrder(IntList L, int v) {
	...
	//Need to check if input is inserted in the beginning or the end of the list
	if (position == 1) {
		L->first = newNode;
	}
